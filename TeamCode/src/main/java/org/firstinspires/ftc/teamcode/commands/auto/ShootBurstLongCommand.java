...
public class ShootBurstLongCommand extends SequentialCommandGroup {

    public ShootBurstLongCommand(ShooterSubsystem shooter,
    ...
    public ShootBurstLongCommand(ShooterSubsystem shooter,
        ...
        this(shooter, hood, kicker, shots,
                LowAltitudeConstants.TargetRPM.LONG_SHOT_RPM, // Corregido: Usar el Enum correcto
