    ...
    public void initialize() {
        ...
        PathChain mainChain = drive.pathBuilder()
                ...
                .addPath(new BezierCurve(
                        new Pose(14.861, 35.000), new Pose(45.722, 35.882), new Pose(61.500, 79.000)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                .addPath(new BezierLine(new Pose(61.500, 79.000), new Pose(39.000, 59.000)))
                .setLinearHeadingInterpolation(Math.toRadians(135), Math.toRadians(180))
                .addPath(new BezierLine(new Pose(39.000, 59.000), new Pose(16.000, 59.000)))
                .setTangentHeadingInterpolation()
                .addPath(new BezierCurve(
                        new Pose(16.000, 59.000), new Pose(44.265, 68.702), new Pose(58.176, 82.839)))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(135))
                .build();
