...
@Autonomous(name = "AutonomoFullCore")
public class AutonomoFullCore extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Action path1 = rrDrive.actionBuilder(startPose)
                .splineToLinearHeading(new Pose2d(55,10,Math.toRadians(160)),Math.toRadians(180))
                .waitSeconds(1)
                .build();

        // Path 2: Simula ir a recoger (Se queda en 0,0)
        Action path2 = rrDrive.actionBuilder(new Pose2d(55, 10, Math.toRadians(160)))
                .splineToLinearHeading(new Pose2d(50,15,Math.toRadians(270)),Math.toRadians(160))
                .strafeTo(new Vector2d(50, 60))
                .strafeTo(new Vector2d(50, 35))
                .build();

        // Path 3: Simula regresar (Se queda en 0,0)
        Action path3 = rrDrive.actionBuilder(new Pose2d(50, 35, Math.toRadians(270)))
                .splineToLinearHeading(new Pose2d(55,10,Math.toRadians(160)),Math.toRadians(270))
                .waitSeconds(1)
                .build();
        Action path4 = rrDrive.actionBuilder(new Pose2d(55, 10, Math.toRadians(160)))
                .splineToLinearHeading(new Pose2d(30,5,Math.toRadians(270)),Math.toRadians(160))
                .waitSeconds(1)
                .build();
        ...
        schedule(new ParallelCommandGroup(
                ...
                new ShooterPIDCommand(shooter, 3700),
                ...
                new SequentialCommandGroup(
                        ...
                        new WaitCommand(128), // Golpe cortito
